<div>
    <div id="loadingScreen" wire:loading.delay wire:target="submit">
        <x-loader />
    </div>
        ...
        <section class=" container d-lg-flex justify-content-between my-lg-5">
                ...
                <div class="main-question">
                    <div class="main-question-part" style="overflow-y: scroll; height:25rem;">
                        ...
                        <div class="question_image">
                            <img src="{{ asset('image/' . $onQuestion?->image . '') }}" class="img-fluid w-100"
                                alt="">
                        </div>
                        ...
                        <table class="table table-borderless mb0">
                            ...
                            <tbody>
                                <tr>
                                    <td> <input {{ $disabled }} wire:model="answer" type="radio" value="1"> 1 )
                                    </td>
                                    <td> <input {{ $disabled }} wire:model="answer" type="radio" value="2"> 2 )
                                    </td>
                                    <td> <input {{ $disabled }} wire:model="answer" type="radio" value="3"> 3 )
                                    </td>
                                    <td> <input {{ $disabled }} wire:model="answer" type="radio" value="4"> 4 )
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                    ...
                    <div class="my-2">
                        <hr>
                        <div class=" my-3">
                            <button wire:click="saveAndNext" type="button"
                                class="btn btn-success shadow rounded my-1">SAVE
                                &
                                NEXT</button>
            ...
            <div class="answerbox-box">
                <div class="timer-box d-flex align-items-center justify-content-center shadow rounded">
                    <span id="timer-clock">1: 56 : 60 </span>
...
@endif
    ...
    <script>
        ...
        let timer = setInterval(function() {
            ...
            document.getElementById("timer-clock").innerHTML = hour + " " + ":" + " " + min + " " + ":" + " " +
                sec;
